...
namespace TableTopBattleTracker.Migrations
{
    ...
    [Migration("20220306152107_ModelCompleted")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TableTopBattleTracker.Model.AreaOfEffect", b =>
                {
                    b.Property<int>("AreaOfEffectId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("AreaOfEffectId"));
            ...
            modelBuilder.Entity("TableTopBattleTracker.Model.CastingComponent", b =>
                {
                    b.HasOne("TableTopBattleTracker.Model.Spell", null)
                        .WithMany("CastingComponents")
            ...
            modelBuilder.Entity("TableTopBattleTracker.Model.Characteristic", b =>
                {
                    b.HasOne("TableTopBattleTracker.Model.Action", null)
                        .WithMany("DCTypes")
                        .HasForeignKey("ActionId");
                });
            ...
            modelBuilder.Entity("TableTopBattleTracker.Model.Spell", b =>
                {
                    b.Navigation("CastingComponents");
                });
